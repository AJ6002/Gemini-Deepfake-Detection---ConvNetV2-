...
# Add parent directory to path so we can find core_prep.py
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
import core_prep

# --- CONFIG ---
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
ZIP_NAME = "DiffFace.zip"
OUTPUT_ROOT = os.path.join(BASE_DIR, "dataset", "ULTRA_SWIN_DATA")
TEMP_EXTRACT = os.path.join(BASE_DIR, "data", "temp_DiffFace")
LIMIT = 5000 
...
def run():
    ...
    print(f"\n✅ SUCCESS: Added {count} DiffFace images.")
    print(f"📢 You can now safely delete '{ZIP_NAME}' from Windows Explorer.")
